...
from models.Cifar10_Classifiers import Cifar10_Classifier_Factory as Targets
from models.Cifar10_Generators import Cifar10_Generator_Factory as Generators
from models.Cifar10_Discriminators import Cifar10_Discriminator_Factory as Discriminators
...
def load_target(name):
    net = Targets.get_model(name)(pretrained=True)
...
if __name__ == "__main__":
    ...
    if opt.output_dir == "" and opt.name == "":
        opt.name = "Cifar10-" + str(torch.random.initial_seed())
    ...
    # Configure data loader using same transforms as pretrained classifier
    mean = [0.4914, 0.4822, 0.4465]
    std = [0.2023, 0.1994, 0.2010]
    os.makedirs(p+"/data/cifar10", exist_ok=True)
